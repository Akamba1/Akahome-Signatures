    ...
    <section className="hero">
      ...
      <div className="hero-grid">
        ...
        <div className="hero-side">
          <p>Akahome Signatures builds traditional and contemporary menswear around your exact measurements — agbada, kaftans, and tailored suiting, finished by hand.</p>
